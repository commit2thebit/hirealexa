...
document.getElementById('mcknight4').addEventListener('click', function() {
    ...
    changeChatContent('Our most capable account associate, great for tasks that require creativity and advanced reasoning, is only available in interview format.', 'chatBody');
});
...
A bit about me: I helped lead GTM for an insurance software company with a special focus in AI applications. <br><br>

I also worked in sales on the Lloyd’s of London trading floor, selling multi-million dollar aircraft coverage and negotiating hull war risks. <br><br>

With no previous coding or website building experience, I used GPT-4 to create a website for recent lay-offs to calculate their personal cash runways. You can view it on GitHub here: https://commit2thebit.github.io/cashrunway/. <br><br>

I also built this website (just for you, OpenAI!) using only ChatGPT. <br><br> 

For McKnight-4 — the most capable account associate yet— please drop me a note below to arrange an interview. <br><br>
